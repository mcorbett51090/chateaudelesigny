...
export const ui = {
  fr: {
    ...
    'consent.load': 'Afficher le contenu',
    'consent.note': 'Ce contenu tiers peut déposer des cookies. En l’affichant, vous y consentez.',
    'newsletter.title': 'Restez informé',
    'newsletter.placeholder': 'Votre adresse e-mail',
    'newsletter.submit': 'S’inscrire',
    'newsletter.consent': 'J’accepte de recevoir la lettre d’information du Château de Lésigny.',
    'reviews.title': 'Avis',
    'reviews.based': 'avis',
  },
  en: {
    ...
    'consent.load': 'Show the content',
    'consent.note': 'This third-party content may set cookies. Showing it means you consent.',
    'newsletter.title': 'Stay in the loop',
    'newsletter.placeholder': 'Your email address',
    'newsletter.submit': 'Subscribe',
    'newsletter.consent': 'I agree to receive the Château de Lésigny newsletter.',
